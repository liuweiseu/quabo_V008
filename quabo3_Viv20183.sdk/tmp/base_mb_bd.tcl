...
# module references:
# PPS_IO, SPI_MUX, SPI_access, elapsed_time_gen, flash_control, in_buf_ds_1bit, in_buf_ds_4bit, in_buf_ds_1bit, stepper_control, stim_gen
...
proc create_root_design { parentCell } {
  ...
  set uart_quabo [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:uart_rtl:1.0 uart_quabo ]
  set user_falsh_spi_0 [ create_bd_intf_port -mode Master -vlnv user.org:user:falsh_spi_rtl:1.1 user_falsh_spi_0 ]
  ...
  set pps_inout [ create_bd_port -dir IO pps_inout ]
  set pps_o_0 [ create_bd_port -dir O pps_o_0 ]
  set quabo_pos0 [ create_bd_port -dir I quabo_pos0 ]
  ...
  # Create instance: ETH_CORE_CTRL_2, and set properties
  set ETH_CORE_CTRL_2 [ create_bd_cell -type ip -vlnv user.org:user:ETH_CORE_CTRL:1.0 ETH_CORE_CTRL_2 ]
  set_property -dict [ list \
   CONFIG.eth {1} \
 ] $ETH_CORE_CTRL_2
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT1_JITTER {122.176} \
   CONFIG.CLKOUT1_PHASE_ERROR {113.630} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {312.5} \
   CONFIG.CLKOUT2_JITTER {165.729} \
   CONFIG.CLKOUT2_PHASE_ERROR {113.630} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {62.5000} \
   CONFIG.CLKOUT2_REQUESTED_PHASE {0.000} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLKOUT3_JITTER {877.934} \
   CONFIG.CLKOUT3_PHASE_ERROR {874.060} \
  ...
  # Create instance: eth_core, and set properties
  set eth_core [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_ethernet:7.1 eth_core ]
  set_property -dict [ list \
   CONFIG.PHY_TYPE {1000BaseX} \
  ...
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] [get_bd_pins /eth_core/axi_rxd_arstn]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] [get_bd_pins /eth_core/axi_rxs_arstn]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] [get_bd_pins /eth_core/axi_txc_arstn]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] [get_bd_pins /eth_core/axi_txd_arstn]

  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {m_axis_rxd:m_axis_rxs:s_axis_txc:s_axis_txd} \
   CONFIG.ASSOCIATED_RESET {axi_rxd_arstn:axi_rxs_arstn:axi_txc_arstn:axi_txd_arstn} \
 ] [get_bd_pins /eth_core/axis_clk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] [get_bd_pins /eth_core/gtref_clk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] [get_bd_pins /eth_core/gtref_clk_buf]

  set_property -dict [ list \
   CONFIG.SENSITIVITY {LEVEL_HIGH} \
 ] [get_bd_pins /eth_core/interrupt]

  set_property -dict [ list \
   CONFIG.SENSITIVITY {EDGE_RISING} \
 ] [get_bd_pins /eth_core/mac_irq]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] [get_bd_pins /eth_core/pma_reset]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {200000000} \
 ] [get_bd_pins /eth_core/ref_clk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /eth_core/rxoutclk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /eth_core/rxuserclk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /eth_core/rxuserclk2]

  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {s_axi} \
   CONFIG.ASSOCIATED_RESET {s_axi_lite_resetn} \
 ] [get_bd_pins /eth_core/s_axi_lite_clk]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] [get_bd_pins /eth_core/s_axi_lite_resetn]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /eth_core/txoutclk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {62500000} \
 ] [get_bd_pins /eth_core/userclk]

  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
 ] [get_bd_pins /eth_core/userclk2]
  ...
  set wrc_board_quabo_Light_0 [ create_bd_cell -type ip -vlnv user.org:user:wrc_board_quabo_Light:1.1 wrc_board_quabo_Light_0 ]
  set_property -dict [ list \
   CONFIG.g_dpram_initf {/home/wei/Desktop/wrc_phy16_sdb.bram} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net AXI_Stream_Switch_0_m_axis [get_bd_intf_pins AXI_Stream_Switch_0/m_axis] [get_bd_intf_pins ETH_CORE_CTRL_0/s_axis_txd]
  connect_bd_intf_net -intf_net ETH_CORE_CTRL_2_m_axis_txc [get_bd_intf_pins ETH_CORE_CTRL_2/m_axis_txc] [get_bd_intf_pins eth_core/s_axis_txc]
  connect_bd_intf_net -intf_net ETH_CORE_CTRL_2_m_axis_txd [get_bd_intf_pins ETH_CORE_CTRL_2/m_axis_txd] [get_bd_intf_pins eth_core/s_axis_txd]
  ...
  connect_bd_intf_net -intf_net axi_ethernet_1_m_axis_rxd [get_bd_intf_pins FIFO_for_AXIS_0/s_axis] [get_bd_intf_pins eth_core/m_axis_rxd]
  connect_bd_intf_net -intf_net axi_ethernet_1_sfp [get_bd_intf_ports sfp_1] [get_bd_intf_pins eth_core/sfp]
  ...
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports uart_quabo] [get_bd_intf_pins axi_uartlite_0/UART]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M00_AXI [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins microblaze_0_axi_periph/M00_AXI]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M15_AXI [get_bd_intf_pins eth_core/s_axi] [get_bd_intf_pins microblaze_0_axi_periph/M15_AXI]
  connect_bd_intf_net -intf_net microblaze_0_debug [get_bd_intf_pins mdm_1/MBDEBUG_0] [get_bd_intf_pins microblaze_0/DEBUG]
  connect_bd_intf_net -intf_net microblaze_0_dlmb_1 [get_bd_intf_pins microblaze_0/DLMB] [get_bd_intf_pins microblaze_0_local_memory/DLMB]
  connect_bd_intf_net -intf_net microblaze_0_ilmb_1 [get_bd_intf_pins microblaze_0/ILMB] [get_bd_intf_pins microblaze_0_local_memory/ILMB]
  connect_bd_intf_net -intf_net wrc_board_quabo_Light_0_falsh_spi [get_bd_intf_ports user_falsh_spi_0] [get_bd_intf_pins wrc_board_quabo_Light_0/falsh_spi]
  ...
  connect_bd_net -net Net3 [get_bd_ports pps_inout] [get_bd_pins PPS_IO_0/pps_inout]
  connect_bd_net -net PPS_IO_0_pps_inside_out [get_bd_pins PPS_IO_0/pps_inside_out] [get_bd_pins elapsed_time_gen_0/one_pps]
  ...
  connect_bd_net -net axi_ethernet_0_fifo_mm2s_cntrl_reset_out_n [get_bd_pins axi_ethernet_0/axi_txc_arstn] [get_bd_pins axi_ethernet_0_fifo/mm2s_cntrl_reset_out_n] [get_bd_pins eth_core/axi_txc_arstn]
  connect_bd_net -net axi_ethernet_0_fifo_mm2s_prmry_reset_out_n [get_bd_pins axi_ethernet_0/axi_txd_arstn] [get_bd_pins axi_ethernet_0_fifo/mm2s_prmry_reset_out_n] [get_bd_pins eth_core/axi_txd_arstn]
  connect_bd_net -net axi_ethernet_0_fifo_s2mm_prmry_reset_out_n [get_bd_pins ETH_CORE_CTRL_2/rst] [get_bd_pins axi_ethernet_0/axi_rxd_arstn] [get_bd_pins axi_ethernet_0/axi_rxs_arstn] [get_bd_pins axi_ethernet_0_fifo/s2mm_prmry_reset_out_n] [get_bd_pins eth_core/axi_rxd_arstn] [get_bd_pins eth_core/axi_rxs_arstn]
  connect_bd_net -net axi_ethernet_0_gt0_qplloutclk_out [get_bd_pins axi_ethernet_0/gt0_qplloutclk_out] [get_bd_pins eth_core/gt0_qplloutclk_in]
  connect_bd_net -net axi_ethernet_0_gt0_qplloutrefclk_out [get_bd_pins axi_ethernet_0/gt0_qplloutrefclk_out] [get_bd_pins eth_core/gt0_qplloutrefclk_in]
  connect_bd_net -net axi_ethernet_0_gtref_clk_buf_out [get_bd_pins axi_ethernet_0/gtref_clk_buf_out] [get_bd_pins eth_core/gtref_clk_buf]
  connect_bd_net -net axi_ethernet_0_gtref_clk_out [get_bd_pins axi_ethernet_0/gtref_clk_out] [get_bd_pins eth_core/gtref_clk]
  connect_bd_net -net axi_ethernet_0_interrupt [get_bd_pins axi_ethernet_0/interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tdata [get_bd_pins ETH_CORE_CTRL_2/s_axis_txd_tdata] [get_bd_pins axi_ethernet_0/m_axis_rxd_tdata] [get_bd_pins axi_ethernet_0_fifo/axi_str_rxd_tdata]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tkeep [get_bd_pins ETH_CORE_CTRL_2/s_axis_txd_tkeep] [get_bd_pins axi_ethernet_0/m_axis_rxd_tkeep] [get_bd_pins axi_ethernet_0_fifo/axi_str_rxd_tkeep]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tlast [get_bd_pins ETH_CORE_CTRL_2/s_axis_txd_tlast] [get_bd_pins axi_ethernet_0/m_axis_rxd_tlast] [get_bd_pins axi_ethernet_0_fifo/axi_str_rxd_tlast]
  connect_bd_net -net axi_ethernet_0_m_axis_rxd_tvalid [get_bd_pins ETH_CORE_CTRL_2/s_axis_txd_tvalid] [get_bd_pins axi_ethernet_0/m_axis_rxd_tvalid] [get_bd_pins axi_ethernet_0_fifo/axi_str_rxd_tvalid]
  connect_bd_net -net axi_ethernet_0_mac_irq [get_bd_pins axi_ethernet_0/mac_irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_ethernet_0_mmcm_locked_out [get_bd_pins axi_ethernet_0/mmcm_locked_out] [get_bd_pins eth_core/mmcm_locked]
  connect_bd_net -net axi_ethernet_0_pma_reset_out [get_bd_pins axi_ethernet_0/pma_reset_out] [get_bd_pins eth_core/pma_reset]
  connect_bd_net -net axi_ethernet_0_rxuserclk2_out [get_bd_pins axi_ethernet_0/rxuserclk2_out] [get_bd_pins eth_core/rxuserclk2]
  connect_bd_net -net axi_ethernet_0_rxuserclk_out [get_bd_pins axi_ethernet_0/rxuserclk_out] [get_bd_pins eth_core/rxuserclk]
  connect_bd_net -net axi_ethernet_0_userclk2_out [get_bd_pins axi_ethernet_0/userclk2_out] [get_bd_pins eth_core/userclk2]
  connect_bd_net -net axi_ethernet_0_userclk_out [get_bd_pins axi_ethernet_0/userclk_out] [get_bd_pins eth_core/userclk]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Bit_0_0/Din] [get_bd_pins Bit_10_13/Din] [get_bd_pins Bit_14_14/Din] [get_bd_pins Bit_15_15/Din] [get_bd_pins Bit_16_18/Din] [get_bd_pins Bit_19_23/Din] [get_bd_pins Bit_1_1/Din] [get_bd_pins Bit_24_27/Din] [get_bd_pins Bit_2_9/Din] [get_bd_pins GPIO/gpio_io_o]
  ...
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins axi_uartlite_0/interrupt] [get_bd_pins xlconcat_0/In6]
  connect_bd_net -net axi_uartlite_1_interrupt [get_bd_pins axi_uartlite_1/interrupt] [get_bd_pins xlconcat_0/In7]
  connect_bd_net -net axi_uartlite_1_tx [get_bd_pins axi_uartlite_1/tx] [get_bd_pins wrc_board_quabo_Light_0/uart_rxd_i]
  ...
  connect_bd_net -net clk_wiz_0_clk_10 [get_bd_pins clk_wiz_0/clk_10] [get_bd_pins elapsed_time_gen_0/clk_10]
  connect_bd_net -net clk_wiz_0_clk_320 [get_bd_pins clk_wiz_0/clk_320] [get_bd_pins elapsed_time_gen_0/clk_320] [get_bd_pins flash_control_0/hs_clk] [get_bd_pins maroc_dc_0/ET_clk]
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins axi_ethernet_0/ref_clk] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins eth_core/ref_clk] [get_bd_pins maroc_dc_0/hs_clk]
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins clk_wiz_1/clk_out3] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins wrc_board_quabo_Light_0/clk_ext_10m]
  ...
  connect_bd_net -net elapsed_time_gen_0_elapsed_time [get_bd_pins elapsed_time_gen_0/elapsed_time] [get_bd_pins maroc_dc_0/elapsed_time]
  ...
  connect_bd_net -net gpio2_io_i_0_1 [get_bd_ports board_loc] [get_bd_pins GPIO/gpio2_io_i] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net io_ctrl0_0_1 [get_bd_ports quabo_pos0] [get_bd_pins PPS_IO_0/io_ctrl0]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins AXI_Stream_Switch_0/clk] [get_bd_pins ETH_CORE_CTRL_0/clk] [get_bd_pins ETH_CORE_CTRL_2/clk] [get_bd_pins FIFO_for_AXIS_0/clk] [get_bd_pins GPIO/s_axi_aclk] [get_bd_pins SPI_access_0/clk] [get_bd_pins axi_ethernet_0/axis_clk] [get_bd_pins axi_ethernet_0/s_axi_lite_clk] [get_bd_pins axi_ethernet_0_fifo/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_IM/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_PH/s_axi_aclk] [get_bd_pins axi_gpio_mech/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_timebase_wdt_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins axi_uartlite_1/s_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins eth_core/axis_clk] [get_bd_pins eth_core/s_axi_lite_clk] [get_bd_pins flash_control_0/clk] [get_bd_pins maroc_dc_0/m00_axis_aclk] [get_bd_pins maroc_dc_0/m01_axis_aclk] [get_bd_pins maroc_dc_0/s00_axi_aclk] [get_bd_pins maroc_slow_control_0/s00_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/M06_ACLK] [get_bd_pins microblaze_0_axi_periph/M07_ACLK] [get_bd_pins microblaze_0_axi_periph/M08_ACLK] [get_bd_pins microblaze_0_axi_periph/M09_ACLK] [get_bd_pins microblaze_0_axi_periph/M10_ACLK] [get_bd_pins microblaze_0_axi_periph/M11_ACLK] [get_bd_pins microblaze_0_axi_periph/M12_ACLK] [get_bd_pins microblaze_0_axi_periph/M13_ACLK] [get_bd_pins microblaze_0_axi_periph/M14_ACLK] [get_bd_pins microblaze_0_axi_periph/M15_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M_1/slowest_sync_clk] [get_bd_pins stepper_control_0/clk] [get_bd_pins stim_gen_0/clk] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins AXI_Stream_Switch_0/rst] [get_bd_pins ETH_CORE_CTRL_0/rst] [get_bd_pins FIFO_for_AXIS_0/rst] [get_bd_pins axi_ethernet_0/s_axi_lite_resetn] [get_bd_pins axi_ethernet_0_fifo/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins axi_uartlite_1/s_axi_aresetn] [get_bd_pins eth_core/s_axi_lite_resetn] [get_bd_pins maroc_dc_0/m00_axis_aresetn] [get_bd_pins maroc_dc_0/m01_axis_aresetn] [get_bd_pins maroc_dc_0/s00_axi_aresetn] [get_bd_pins maroc_slow_control_0/s00_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/M06_ARESETN] [get_bd_pins microblaze_0_axi_periph/M07_ARESETN] [get_bd_pins microblaze_0_axi_periph/M08_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  connect_bd_net -net stim_gen_0_stim_drive [get_bd_ports stim_drive] [get_bd_pins stim_gen_0/stim_drive] [get_bd_pins xlconcat_1/In0]
  ...
  connect_bd_net -net wrc_board_quabo_Light_0_pps_o [get_bd_ports pps_o_0] [get_bd_pins PPS_IO_0/pps_inside_in] [get_bd_pins flash_control_0/one_pps] [get_bd_pins wrc_board_quabo_Light_0/pps_o]
  ...
  connect_bd_net -net wrc_board_quabo_Light_0_uart_txd_o [get_bd_pins axi_uartlite_1/rx] [get_bd_pins wrc_board_quabo_Light_0/uart_txd_o]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins axi_intc_0/intr] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins axi_gpio_mech/gpio2_io_i] [get_bd_pins xlconcat_2/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axi_ethernet_0/signal_detect] [get_bd_pins eth_core/signal_detect] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_timer_0/capturetrig0] [get_bd_pins axi_timer_0/capturetrig1] [get_bd_pins axi_timer_0/freeze] [get_bd_pins maroc_dc_0/ext_trig] [get_bd_pins xlconstant_1/dout]
  ...
  connect_bd_net -net xlslice_0_Dout1 [get_bd_pins PPS_IO_0/io_ctrl1] [get_bd_pins xlslice_0/Dout]
  ...
  connect_bd_net -net xlslice_3_Dout [get_bd_pins xlconcat_1/In1] [get_bd_pins xlslice_3/Dout]
  ...
  create_bd_addr_seg -range 0x00040000 -offset 0x40C40000 [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs eth_core/s_axi/Reg0] SEG_axi_ethernet_1_Reg0
  create_bd_addr_seg -range 0x00040000 -offset 0x40C40000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs eth_core/s_axi/Reg0] SEG_axi_ethernet_1_Reg0
