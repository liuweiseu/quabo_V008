...
void UpdateGPIO(void)
{
	XGpio_DiscreteWrite(&Gpio, GPIO_OUT_CHAN, (wr_int_arm<<15)|(spi_sel<<14)|(stim_rate<<10) | (stim_level<<2) | (stim_on<<1) | hv_rstb );
}
