...
proc create_root_design { parentCell } {
  ...
  set spi_sel_0 [ create_bd_port -dir I spi_sel_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_hwicap_0/S_AXI_LITE] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_interconnect_0/M01_AXI] [get_bd_intf_pins axi_quad_spi_1/AXI_LITE]
  ...
  connect_bd_net -net SPI_STARTUP_0_mb_spi_intc [get_bd_pins axi_quad_spi_1/ip2intc_irpt] [get_bd_pins xlconcat_0/In7]
  ...
  connect_bd_net -net axi_hwicap_0_ip2intc_irpt [get_bd_pins axi_hwicap_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In6]
  ...
  connect_bd_net -net clk_wiz_1_clk_out2 [get_bd_pins axi_ethernet_0/ref_clk] [get_bd_pins clk_wiz_1/clk_out2] [get_bd_pins maroc_dc_0/hs_clk]
  connect_bd_net -net clk_wiz_1_clk_out3 [get_bd_pins clk_wiz_1/clk_out3] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins wrc_board_quabo_Light_0/clk_ext_10m]
  ...
  connect_bd_net -net spi_sel_0_1 [get_bd_ports spi_sel_0] [get_bd_pins SPI_STARTUP_0/spi_sel]
  ...
  connect_bd_net -net wrc_board_quabo_Light_0_pps_o [get_bd_ports pps_o_0] [get_bd_pins elapsed_time_gen_0/one_pps] [get_bd_pins flash_control_0/one_pps] [get_bd_pins wrc_board_quabo_Light_0/pps_o]
