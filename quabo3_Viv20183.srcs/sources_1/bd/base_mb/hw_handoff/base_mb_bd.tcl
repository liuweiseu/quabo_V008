...
# module references:
# SPI_MUX, SPI_access, elapsed_time_gen, flash_control, in_buf_ds_1bit, in_buf_ds_4bit, in_buf_ds_1bit, stepper_control, stim_gen
